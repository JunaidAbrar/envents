    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'Customer'), ('venue_owner', 'Venue Owner'), ('service_provider', 'Service Provider'), ('admin', 'Administrator')], default='customer', max_length=20)),
